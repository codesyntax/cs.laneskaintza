...
laneskaintzaSchema = folder.ATFolderSchema.copy() + atapi.Schema((
   ...
   atapi.FileField('file_information',
		  ...
		  languageIndependent=1,
                  widget=atapi.FileWidget(
                     ...
                     label_msgid='label_file_information',
                     description_msgid='description_file_information',
                     ),
                  ),
   atapi.FileField('file_enrolled',
		  ...
		  languageIndependent=1,
                  widget=atapi.FileWidget(
                     label='file_enrolled',
                     label_msgid='label_file_enrolled',
                     description_msgid='description_file_enrolled',
                     ),
                  ),
   atapi.FileField('file_exercises',
		  ...
		  languageIndependent=1,
                  widget=atapi.FileWidget(
                     label='file_exercises',
                     label_msgid='label_file_exercises',
                     description_msgid='description_file_exercises',
                     ),
                  ),
   atapi.FileField('file_exercise_results',
		  ...
		  languageIndependent=1,
                  widget=atapi.FileWidget(
                     label='file_exercise_results',
                     label_msgid='label_file_exercise_results',
                     description_msgid='description_file_exercise_results',
                     ),
                  ),
   atapi.StringField('situation',
		  ...
		  vocabulary='whichsituation',
                  widget=atapi.SelectionWidget(
                     label='situation',
                     label_msgid='label_situation',
                     description_msgid='description_situation',
